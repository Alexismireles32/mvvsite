 ...
 * - Imágenes dentro del contenido: usar fotos de salud genéricas relevantes (Unsplash)
 * - Logo del equipo MVV: SIEMPRE usar https://res.cloudinary.com/dsulhqvza/image/upload/v1761550208/mvvnatural_pbzwrl.png
 * - Figcaption: descripción relevante al contenido del artículo
 * - Tamaño de imágenes en contenido: 1200x800px
        ...
        <div className="mx-auto max-w-lg">
            ...
            <Fragment>
              ...
              <figure>
                <img
                  ...
                  alt="Alimentación saludable y nutritiva"
                />
                <figcaption>Una dieta balanceada es clave para un metabolismo óptimo</figcaption>
              </figure>
              <h6>
          ...
          <div>
            <div className="mb-8 text-center md:mb-10 lg:mb-12">
              <p className="font-semibold md:text-md">Compartir artículo</p>
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grow">
              <p className="font-semibold md:text-md">Equipo MVV</p>
              <p>Expertos en suplementación natural</p>
            </div>
          </div>
        </div>
      </div>
